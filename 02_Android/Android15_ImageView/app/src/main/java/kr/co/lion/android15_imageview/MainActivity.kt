    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMainBinding.apply {
            button.setOnClickListener {
                // 웹서버가 제공하는 이미지를 제공하고자 할 때
                // imageView3.setImageURI(사이트 주소를 관리하는 URI 객체)

                // 프로젝트의 res/drawable, res/maipmap 폴더에 있는 이미지를 보여주고자 할 때
//                imageView2.setImageResource(R.drawable.img_android)
                ...
                // Bitmap이나 Drawable 객체로 만들어 쓰는 이미지는 res 폴더 내부가 아닌 곳에
                // 존재하는 이미지를 가져다 사용할 때 이 타입의 객체로 만들어 사용함
                // Bitmap과 Drawable 둘 다 제공하는 작업인 경우 Bitmap을 추천함
