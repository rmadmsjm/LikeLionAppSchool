...
class InputStudentInfoActivity : AppCompatActivity() {
    ...
    val studentArray = arrayOf<String>()
...
//                studentArray.plus(nameInput.text.toString())
//                studentArray.plus(gradeInput.text.toString())
//                studentArray.plus(korInput.text.toString())
//                studentArray.plus(engInput.text.toString())
//                studentArray.plus(mathInput.text.toString())
...
//                studentInfos.putExtra("studentInfos", studentArray)
