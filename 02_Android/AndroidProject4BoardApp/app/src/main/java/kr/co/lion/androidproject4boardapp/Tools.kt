...
class Tools {
    companion object {
        ...
        fun saveImageViewData(context: Context, imageView: ImageView, fileName: String) {
            ...
            // imageView에서 BitmapDrawable 객체 추출하기
...
// 게시판 종류 나타내는 값 정의
enum class ContentType(var str: String, var num: Int) {
    TYPE_ALL("전체 게시판", 0),
    TYPE_FREE("자유 게시판", 1),
    TYPE_HUMOR("유머 게시판", 2),
    TYPE_SOCIETY("시사 게시판", 3),
