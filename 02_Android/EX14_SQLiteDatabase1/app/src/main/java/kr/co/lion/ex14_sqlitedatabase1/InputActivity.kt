...
import kr.co.lion.ex14_sqlitedatabase1.databinding.ActivityInputBinding
...
class InputActivity : AppCompatActivity() {
    ...
    fun processInputDone(){
        ...
        activityInputBinding.apply {
            ...
            // 데이터베이스 저장
            val studentModel = StudentModel(0, name, gradeStr.toInt(), korStr.toInt(), engStr.toInt(), mathStr.toInt())
            StudentDao.insertStudent(this@InputActivity, studentModel)
