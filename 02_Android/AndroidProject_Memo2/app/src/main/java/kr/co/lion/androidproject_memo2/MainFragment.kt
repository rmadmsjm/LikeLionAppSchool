...
class MainFragment : Fragment() {
    ...
    fun replaceFragment(name:MemoFragmentName, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            MemoFragmentName.CALENDAR_FRAGMENT -> {
                newFragment = CalendarFragment()
            }
            MemoFragmentName.TOTALMEMO_FRAGMENT -> {
...
enum class MemoFragmentName(var str: String) {
