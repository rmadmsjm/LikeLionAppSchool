...
// 클래스를 인터페이스로 사용함
// 쉼표로 구분하여 다수를 작성해도 됨
// 클래스를 인터페이스로 구현할 경우 클래스가 가진 모든 변수와 모든 메서드들을 재구현 해야 함
// 즉, 부모가 가지고 있는 것을 물려받는 개념이 아니고 전부 다시 구현하는 개념
class Dog2 implements Animal{
  late int dogRunLength;

  // Animal이 가지고 있는 모든 변수를 다시 정의해야 함
  @override
  int age;
  ...
  // Animal이 가지고 있는 모든 메서드를 다시 구현해야 함
  @override
  void showAge() {
